...
<div id="page" class="site">
	<a class="skip-link screen-reader-text" href="#content"><?php esc_html_e( 'Skip to content', 'twentynineteen' ); ?></a>
		...
		<header id="masthead" class="<?php echo twentynineteen_can_show_post_thumbnail() ? 'site-header featured-image' : 'site-header'; ?>">
			...
			<?php if ( twentynineteen_can_show_post_thumbnail() ) : ?>
				<php //if ( is_singular() OR ( is_home() AND ! is_front_page() ) ) : ?>
